    ...
    <main className="min-h-screen bg-background">
      ...
      >
        ...
        <div className="absolute inset-0 pointer-events-auto">
          ...
          {/* LOGO - using flexbox for true center */}
          <div className="absolute inset-0 flex items-center justify-center z-10" style={{ paddingBottom: '25vh' }}>
            <motion.div
          ...
          {/* SLOGAN */}
          <div className="absolute inset-0 flex items-center justify-center z-20" style={{ paddingTop: '20vh' }}>
