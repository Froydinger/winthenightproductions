      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <Card className="group relative overflow-hidden bg-gradient-to-br from-card/60 to-charcoal/40 backdrop-blur-glass border border-neon-blue/30 p-6 sm:p-10 lg:p-12 hover:border-neon-blue/60 transition-all duration-500 hover:shadow-neon-strong animate-fade-in-up">
            ...
            {/* Floating icon */}
            <div className="absolute top-4 right-4 sm:top-6 sm:right-6 w-10 h-10 sm:w-16 sm:h-16 rounded-full bg-neon-blue/10 flex items-center justify-center group-hover:scale-125 group-hover:rotate-12 transition-all duration-500">
              <MessageCircle className="w-4 h-4 sm:w-7 sm:h-7 text-neon-blue" />
            </div>
